package oc.p.chapters.c_8_IO.workingWithStreams.objectInputStreamAndObjectOutputStream.understandingObjectCreation;
...
class Anim implements Serializable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        File f = Resources.Files.file(a.getClass().getPackage(), "a");
